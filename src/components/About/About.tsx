        ...
        >
          <div className="space-y-6 text-slate-300 text-lg leading-relaxed">
            <p className="font-medium text-white text-xl">
              Hi there! I&apos;m Duong Van Manh, a passionate software developer with over 3 years of experience 
            ...
            <p>
              ...
              modern technologies like <span className="font-semibold text-blue-400">React</span>, 
              <span className="font-semibold text-blue-400"> Next.js</span>, and 
              <span className="font-semibold text-blue-400"> TypeScript</span>. My approach combines 
          ...
          {/* Interests */}
          <div className="pt-6">
            <h3 className="mb-4 font-semibold text-white text-xl">What I&apos;m passionate about:</h3>
